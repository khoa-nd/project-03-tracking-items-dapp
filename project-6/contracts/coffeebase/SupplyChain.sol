...
contract SupplyChain is DistributorRole, RetailerRole, ConsumerRole {
        ...
        string memory _productNotes) public
    {
        ...
        items[_upc] = Item({sku : sku, upc : _upc, ownerID : _originFarmerID, originFarmerID : _originFarmerID,
            ...
            productID: productID, productNotes : _productNotes, productPrice : 0, itemState : State.Harvested,
            distributorID: address(0x0), retailerID: address(0x0), consumerID: address(0x0)});
        // Increment sku
        sku = sku + 1;
    ...
    function sellItem(uint _upc, uint _price) public
        // Call modifier to check if upc has passed previous supply chain stage
        harvested(_upc) processed(_upc) packed(_upc)
        // Call modifier to verify caller of this function
    ...
    function buyItem(uint _upc) public payable
        // Call modifier to check if upc has passed previous supply chain stage
        harvested(_upc) processed(_upc) packed(_upc) forSale(_upc)
